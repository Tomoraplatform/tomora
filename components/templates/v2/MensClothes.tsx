  ...
  return (
    <BrandStyle brandColor={brandColor} className="bg-white font-sans text-neutral-900">
      ...
      <footer className="border-t border-neutral-200">
        ...
        <div className="border-t border-neutral-100 py-5 text-center text-sm text-neutral-400">© {new Date().getFullYear()} {name}. {siteData.footerCredit ?? "Built with Tomora"}</div>
      </footer>
    </BrandStyle>
  );
}
