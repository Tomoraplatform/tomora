...
import {
  ...
  UploadCloud, Loader2, PartyPopper, ExternalLink, Pencil, Eye, X, UtensilsCrossed } from "lucide-react";
...
const ICONS = { ShoppingBag, User, GraduationCap, Heart, CalendarDays, Palette, UtensilsCrossed } as const;
