...
import {
  ...
  Globe, CreditCard, Settings, Menu, X, LogOut, ExternalLink, LayoutTemplate, Star, Inbox, MessagesSquare, Heart, Trophy, Ticket, Truck, MoreHorizontal, LifeBuoy, Wallet, UsersRound, UtensilsCrossed, FlaskConical, TrendingUp, MessageCircle } from "lucide-react";
...
const ICONS = {
  LayoutDashboard, Pencil, Palette, Package, ShoppingBag, Banknote, Globe, CreditCard, Settings, LayoutTemplate, Star, Inbox, MessagesSquare, Heart, Trophy, Ticket, Truck, LifeBuoy, Wallet, UsersRound, UtensilsCrossed, FlaskConical, TrendingUp, MessageCircle,
} as const;
