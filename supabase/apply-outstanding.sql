...
-- The Supabase SQL editor runs this as one transaction: if any
-- part fails, none of it is applied and you are back where you
-- started.
--
-- Generated from supabase/migrations. Do not edit this file.
-- Edit the numbered migrations and regenerate.
-- =============================================================
